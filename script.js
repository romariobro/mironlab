const translations = {
  ru: {
    ...
    aboutText: "Мой опыт работы с IT-проектами начинается с 2008 года и включает разработку веб-сайтов, интернет-магазинов, промо-страниц, облачных сервисов, а также мобильных приложений и проектов в игровой разработке. Я реализую IT-проекты под ключ — от идеи до запуска — и обладаю опытом управления IT-командами и проектным офисом в стартапах и enterprise-проектах.",
    portfolioLabel: "Проекты и резюме",
    studioLabel: "Услуги для проектов",
  ...
  en: {
    ...
    aboutText: "I have worked with IT projects since 2008, including websites, online stores, promotional pages, cloud services, mobile applications and game development projects. I deliver IT initiatives end to end — from idea to launch — and have experience managing IT teams and project management offices in startups and enterprise environments.",
    portfolioLabel: "Projects and CV",
    studioLabel: "Services for products",
